...
<div class="w3l-searchblock w3l-homeblock1 py-5">
    <div class="container py-lg-4 py-md-3">
        ...
        $posts = [
            [
                'title' => 'How To Be The First to Post A Comment on a Blog-Post?',
                'image' => 'assets/images/blog.jpg',
                'excerpt' => 'Lorem ipsum dolor sit amet consectetur ipsum adipisicing elit. Qui eligendi vitae sit.',
                'date' => 'April 13, 2020',
                'read_time' => '6min read'
            ],
            // Additional posts...
            ...
            <div class="col-md-12 item">
                <div class="card">
                    <div class="card-header p-0 position-relative">
                        <a href="#blog-single">
                            <img class="card-img-bottom d-block radius-image" src="<?php echo $post['image']; ?>" alt="Post image">
                        </a>
                    </div>
                    <div class="card-body p-0 blog-details">
                        ...
                        <div class="author align-items-center mt-3 mb-1">
                            <a href="#author"><?php echo $author; ?></a> in <a href="#url">Design</a>
                        </div>
                        <ul class="blog-meta">
                            <li class="meta-item blog-lesson"><span class="meta-value"><?php echo $post['date']; ?></span></li>
                            <li class="meta-item blog-students"><span class="meta-value"><?php echo $post['read_time']; ?></span></li>
                        </ul>
                    </div>
                </div>
            </div>
